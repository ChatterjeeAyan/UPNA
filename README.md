...
\textcolor{blue}{UPNA can be extended to any pairwise learning task, such as the cold-start problem in recommender systems and entity resolution. UPNA integrated with link prediction models leveraging attribute information can improve the generalizability of a wide class of state-of-the-art methods.
